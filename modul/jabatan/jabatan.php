	...
	<form action='$aksi?module=jabatan&act=input' method='post'>
		<table class='tabelform'>
			<tr>
				...
				<td><input class='form-controltxt' name='id' type='text' value=".kdauto(jabatan,J)." readonly></td>
			</tr>
			<tr>
				<td>JABATAN</td>
	...
	<form action='$aksi?module=jabatan&act=edit' method='post'>
		<table class='tabelform'>
			<tr>
				...
				<td><input class='form-controltxt' name='id' type='text' value='$data[id_jab]'></td>
			</tr>
			<tr>
				<td>NAMA BAGIAN</td>
