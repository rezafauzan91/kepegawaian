<?php
	...
	// if ($_SESSION['leveluser']=='3' or $_SESSION['leveluser']=='1'){
	...
	else if($_GET['module']=="golongan"){
		include "modul/golongan/golongan.php";
	}
	...
	else if($_GET['module']=="mutasi"){
		include "modul/mutasi/mutasi.php";
	}
	...
	else if($_GET['module']=="kg"){
		include "modul/k_golongan/k_golongan.php";
	}
